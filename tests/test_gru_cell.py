...
import mindspore
import numpy as np
from rnns.rnn_cells import GRUCell
...
class TestGRUCell(unittest.TestCase):
    ...
    def test_gru_cell(self):
        net = GRUCell(self.input_size, self.hidden_size)
    ...
    def test_gru_cell_forward(self):
        net_ms = GRUCell(self.input_size, self.hidden_size)
        ...
        net_pt = torch.nn.GRUCell(self.input_size, self.hidden_size)
